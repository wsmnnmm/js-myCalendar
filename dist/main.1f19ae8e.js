...
g('#prevMonth').onclick = function () {
  var 月初 = new Date(currentTime.getFullYear(), currentTime.getMonth(), 1);
...
function render(time) {
  ...
  function generateDays() {
    ...
    for (var _i = 1; _i < 月初星期几; _i++) {
      var li = document.createElement('li');
      var d = new Date(月初 - 86400 * 1000 * _i);
    ...
    for (var j = 0; j < 42 - n; j++) {
      ...
      var _d = new Date(月末 - 0 + 86400 * 1000 * date);
